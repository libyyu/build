...
set(DIST_INFOFILE ${CMAKE_CURRENT_SOURCE_DIR})
## Extract information from dist.info
if ( NOT EXISTS ${DIST_INFOFILE}/dist.info )
  message ( FATAL_ERROR
    "Missing dist.info file (${DIST_INFOFILE}/dist.info)." )
endif ()
file ( READ ${DIST_INFOFILE}/dist.info DIST_INFO )
...
set ( CMAKE_MODULE_PATH "${DIST_INFOFILE}/cmake" ${CMAKE_MODULE_PATH} )
...
macro ( install_header )
  ...
  foreach ( _file ${_ARG_DEFAULT_ARGS} )
    if ( IS_DIRECTORY "${DIST_INFOFILE}/${_file}" )
