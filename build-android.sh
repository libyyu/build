...
cd ..
$GCC -fPIC slua.c pb.c $NDKF -o ./Plugins/Android/libs/armeabi-v7a/libslua.so -shared -Iluajit/src -I$CPPDIR -Wl,--whole-archive android/armv7-a/libluajit.a -Wl,--no-whole-archive -L$LIBDIR -static-libgcc -static-libstdc++