...
mkdir %PROJECT_PATH%\bin\x86
copy /Y lua51_d.lib %PROJECT_PATH%\lib\x86\libluajit_d.lib
copy /Y luajit.exe %PROJECT_PATH%\bin\x86\luajit_d.exe
...
mkdir %PROJECT_PATH%\lib\x86
mkdir %PROJECT_PATH%\bin\x86
copy /Y lua51.lib %PROJECT_PATH%\lib\x86\libluajit.lib
copy /Y luajit.exe %PROJECT_PATH%\bin\x86\luajit.exe
...
mkdir %PROJECT_PATH%\bin\x64
copy /Y lua51_d.lib %PROJECT_PATH%\lib\x64\libluajit_d.lib
copy /Y luajit.exe %PROJECT_PATH%\bin\x64\luajit_d.exe
...
mkdir %PROJECT_PATH%\lib\x64
mkdir %PROJECT_PATH%\bin\x64
copy /Y lua51.lib %PROJECT_PATH%\lib\x64\libluajit.lib
copy /Y luajit.exe %PROJECT_PATH%\bin\x64\luajit.exe
