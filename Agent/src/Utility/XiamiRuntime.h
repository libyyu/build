...
#define  __MyNameSpaceBegin       __NameSpaceBegin(Xiami)
#define  __MyNameSpaceEnd         __NameSpaceEnd
#define  __MyNameSpace(class)     Xiami::class
...
#define XIAMI_SNPRINTF _snprintf_s
#define XIAMI_SSCANF   sscanf_s
#elif defined(_MSC_VER) && (_MSC_VER >= 1200 )
// Microsoft visual studio, version 6 and higher.
//#pragma message( "Using _sn* functions." )
#define XIAMI_SNPRINTF _snprintf
#define XIAMI_SSCANF   sscanf
#elif defined(__GNUC__) && (__GNUC__ >= 3 )
// GCC version 3 and higher.s
//#warning( "Using sn* functions." )
#define XIAMI_SNPRINTF snprintf
#define XIAMI_SSCANF   sscanf
#else
#define XIAMI_SNPRINTF snprintf
#define XIAMI_SSCANF   sscanf
